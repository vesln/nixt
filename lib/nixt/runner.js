...
Runner.prototype.run = function(command) {
  var self = this;
  if (this.batch.hasMain()) throw new Error('You can execute `run` only once');
  // TODO: woot
  this.command().command(command);

  this.batch.main(function(fn) {
    self.command().execute(function(result) {
      var err = null;
