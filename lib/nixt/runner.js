...
Runner.prototype.timeout = function(ms) {
  ...
  this.expectations.push(expect.time(ms));
  return this;
};
...
Runner.prototype.stdout = function(pattern) {
  this.expectations.push(expect.stdout(pattern));
  return this;
};
...
Runner.prototype.stderr = function(pattern) {
  this.expectations.push(expect.stderr(pattern));
  return this;
};
...
Runner.prototype.code = function(code) {
  this.expectations.push(expect.code(code));
  return this;
};
